...
- **2026-09-25 — Lift/cutdown pricing SETTLED (Spencer): lift usage = parent minus 25–50% (client pays 50–75% of parent), per the guide.** Open at 25% off, 50% off is the floor for multi-lift bundles; cap the count in writing. Old "25–50% *of* parent" convention retired. In `quick-quote.md` + `vo-pricing` skill.
