...
- **2026-09-25 — "log" always means "log this" (Spencer).** A bare "log" = write what just happened to memory + commit, immediately, one-line confirm. Never ask, never show the log.
