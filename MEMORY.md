...
- Treated home studio, **Source Connect** + **Pro Tools certified** (ProMedia Training, Sept 2025). 24h standard turnaround, same-day rush.
...
5. **Update 2026-09-21 (live tracker check):** workshop tracker row now shows "Workshop Completed - Awaiting Workshop #2 Info" (09/20) — ahead of the 9/22 check-in Routine.
6. **Update 2026-09-21 (Spencer):** he's already reached out to Elaine Craig to see if she'll produce/review his commercial reel. Plans to sign up for **Workshop #2** and one-on-one lessons with her too. This is the reel-rebuild blocker and the DDO training thread converging — Elaine reviewing/producing the reel could double as continued proof of training. **Bingo's read:** good move, but don't let Workshop #2 / ongoing lessons become the reason resubmission to Allie keeps sliding — the Aug 5 condition ("take a commercial class") was already satisfied by the completed VO Pro 1 workshop. Resubmit to Allie once the reel is in hand from Elaine; treat Workshop #2 and 1:1 lessons as ongoing development, not a second gate.
