...
## 2026-09-25 — Funnels C2 + E + F drafted (all unsent, in Gmail, spencer@spencerzvoice.com)
- Format (Spencer's sent Airtable/Kirsten email, 09-24): greeting -> current-event hook (skipped when none) -> intro (Lisbon, warm bass/baritone, AWS Sagemaker, Artlist, FIFA WC 2026 preview series, Venmo, Dell, "among others", spencerzvoice.com) -> "I put together a re-voice of your "<Title>" video. Give it a listen!" (hyperlinked, placeholder href) -> close incl. "Feel free to reach out or schedule a call...". Subject "A voice for <Co>'s video work". HTML-only via FGAC (PUT/POST), labels re-applied after each PUT.
