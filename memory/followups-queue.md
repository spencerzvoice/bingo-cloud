...
| Funnel D Skillsoft: Alice Lamey | 2026-09-24 (Gmail Sent, verified) | 1 | touch 2 | Tue 2026-10-06 (prep Mon 10-05 eve) | Thu 2026-10-08 | OOO until Thu 10-01; do NOT redirect to her auto-reply contacts. Tracker row 130 |
...
| Cold finals still unsent: Sascha (Team One), Tanya, Josephine, Nancy (Untold), Nathan (The Team) | drafted 09-24; subjects re-fixed 09-25 | 3 (final) when sent | send | **Fri 2026-09-25 (DUE, reminded)** | Fri 2026-10-02 (one nudge if still unsent) | Tanya 09-25, Josephine + Nancy together Mon 09-28 (Spencer ok 09-25); set revisit = send + ~5 wks |
...
## Flagged, NOT drafted (2026-09-24)
- **Michael MacMillan (Anomaly)** — already 3 touches (7/29, 8/24, 9/1). Digest over-flagged. October revisit.
- **Mackenzie Prokos (Rune Haus)** — she replied 9/2, Spencer answered; conversation closed warmly. Tracker note stale.
- **Luke Mellows (Noah Media)** — tracker says reconnect sent 8/26, but no such Sent message found (`to:luke.mellows@noahmediagroup.com`, 60d). Likely never sent. Needs Spencer's call on a first warm reconnect (last real thread Dec 2024).
- **Jamie Pearson (IMG/EuroLeague)** — preseason check-in never sent, but Ian Henderson (same org) just said budget is tight (9/23) and the 9/25 invoice is pending. Hold until invoice clears; Spencer's call.
